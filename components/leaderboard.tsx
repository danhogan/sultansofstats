...
export default function EnhancedTable(props: any) {
    ...
    const rows = regularRows.map((row: any) => {
        return {
            ...row,
            HR: Number(row.stats.HR.replace(/\,/g,'')),
            R: Number(row.stats.R.replace(/\,/g,'')),
            RBI: Number(row.stats.RBI.replace(/\,/g,'')),
            SB: Number(row.stats.SB.replace(/\,/g,'')),
            OBP: Number(row.stats.OBP.replace(/\,/g,'')),
            OPS: Number(row.stats.OPS.replace(/\,/g,'')),
            SO: Number(row.stats.SO.replace(/\,/g,'')),
            SV: Number(row.stats.SV.replace(/\,/g,'')),
            HD: Number(row.stats.HD.replace(/\,/g,'')),
            ERA: Number(row.stats.ERA.replace(/\,/g,'')),
            WHP: Number(row.stats.WHP.replace(/\,/g,'')),
            QS: Number(row.stats.QS.replace(/\,/g,'')),
